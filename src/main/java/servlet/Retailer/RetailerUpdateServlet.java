...
@WebServlet(name = "RetailerUpdateServlet", value = "/RetailerUpdateServlet")
public class RetailerUpdateServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            if (DaoFactory.retailerDaoInstance().updateRetailer(retailer)) {

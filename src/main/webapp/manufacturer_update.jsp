    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">制造商信息修改</h1>
            </div>
            <!-- Custom -->
            <div class="justify-content-center">
                <form name="form" action="ManufacturerUpdateServlet" method="post">
                    <div class="user">
...
<script>
    document.getElementById("manufacturerId").value=getUrlVariable("manufacturerId");
</script>
</body>
</html>

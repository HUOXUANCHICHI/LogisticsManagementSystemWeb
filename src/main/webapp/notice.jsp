    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">发布公告</h1>
            </div>
            <!-- Custom -->
            <div
                    class="
            ...
            "
                    ...
                    id="alert"
            >
                <h4 class="alert-heading">发布成功！</h4>
            </div>
            ...
            <div class="form-group">
              ...
              ></textarea>
                ...
                <br/>
                <button
                        class="btn btn-primary btn-user btn-block col-3 col-sm-6 col-lg-3"
                        style="left: 100px"
                        id="btn"
                >
                    发布
    ...
    $(function () {
        $("#btn").click(function (e) {
            $("#alert").toggle(function () {
                $(this).attr("style", "left: 100px; display:;");
            });
        });
    });
</script>

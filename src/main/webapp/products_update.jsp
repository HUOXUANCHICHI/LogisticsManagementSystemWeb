    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">产品信息修改</h1>
            </div>
            <!-- Custom -->
            <div class="justify-content-center">
                <form name="form" action="ProductsUpdateServlet" method="post">
                    <div class="user">
...
<script>
    document.getElementById("productsId").value = getUrlVariable("productsId");
</script>
</body>
</html>

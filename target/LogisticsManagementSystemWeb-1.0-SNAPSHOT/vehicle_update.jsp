    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">车辆信息修改</h1>
            </div>
            <!-- Custom -->
            <div class="justify-content-center">
                <form name="form" action="VehicleUpdateServlet" method="post">
                    <div class="user">
...
<script>
    document.getElementById("vehicleId").value = getUrlVariable("vehicleId");
</script>
</body>
</html>
